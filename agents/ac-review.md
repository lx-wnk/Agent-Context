...
name: ac-review
description:
  "Comprehensive code review agent. Delegates here for PR reviews, code quality checks, architecture analysis, and
  security audits. Read-only — never modifies code."
