...
- **Generated artifacts** (`outputs/`): Reports produced by skills — review findings, handoffs, audits, analyses. Git-ignored, never installed, never referenced by shared files or tests. Regenerate rather than edit; deleting the directory must never break anything.
